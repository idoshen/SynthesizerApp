...
public class Tremolo extends SynthControlContainer implements AudioEffect {
    public LowFrequencyOsillator lfo;
    public double lfoSample;


    public Tremolo(Synthesizer synthesizer) {
        super(synthesizer);
        ...
        JLabel LFOLabel = new JLabel("Tremolo:");
    ...
    public double applyEffect(double sample) {
        if (on) {
            return ((lfoSample * lfo.getDepth()) + (1 - lfo.getDepth())) * sample;
        }
        return sample;
    }
